...
CREATE TABLE IF NOT EXISTS `spss`.`User` (
  ...
  `Authorized` TINYINT NULL DEFAULT 0,
  `UserType` ENUM('ufes', 'sead') NULL,
  PRIMARY KEY (`UserOID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `spss`.`PhysicalPerson` (
  ...
  `Ethnicity` ENUM('Branco', 'Pardo', 'Negro', 'Indígena', 'Amarelo') NULL,
  `MaritalStatus` ENUM('Solteiro', 'Casado', 'Divorciado', 'Viúvo', 'Separado') NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`TargetType` (
  `TargetTypeOID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Action` (
  `ActionOID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`ErrorType` (
  `ErrorTypeOID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`ErrorLog` (
  `ErrorLogOID` INT NOT NULL AUTO_INCREMENT,
  `CreationTimeStamp` DATETIME NULL,
  `Description` VARCHAR(45) NULL,
