...
CREATE TABLE IF NOT EXISTS `spss`.`Address` (
  ...
  `Add_Cit_CityOID` INT NULL,
  `Add_Per_PersonOID` INT NULL,
...
-- Table `spss`.`Sex`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spss`.`Sex` ;

CREATE TABLE IF NOT EXISTS `spss`.`Sex` (
...
CREATE TABLE IF NOT EXISTS `spss`.`PhysicalPerson` (
  ...
  `BirthPlace` INT NULL,
  `Phy_Eth_EthnicityOID` INT NULL,
  `Phy_Mar_MaritalStatusOID` INT NULL,
  `Phy_Use_UserOID` INT NULL,
  `Phy_Sex_SexOID` INT NULL,
  `RgState` INT NULL,
  ...
  INDEX `FK_Phy_Sex_SexOID_idx` (`Phy_Sex_SexOID` ASC),
  ...
  CONSTRAINT `FK_Phy_Use_UserOID`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_Phy_Sex_SexOID`
    FOREIGN KEY (`Phy_Sex_SexOID`)
    REFERENCES `spss`.`Sex` (`SexOID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `spss`.`Candidate` (
  ...
  `Poor` TINYINT NULL,
  `Can_Phy_PhysicalPersonOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Call` (
  ...
  `Cal_Sel_SelectiveProcessOID` INT NULL,
  PRIMARY KEY (`CallOID`),
...
CREATE TABLE IF NOT EXISTS `spss`.`Vacancy` (
  ...
  `Vac_Des_DesignationOID` INT NULL,
  `Vac_Cal_CallOID` INT NULL,
  `Vac_Res_RestrictionOID` INT NULL,
  `Vac_Sel_SelectiveProcessOID` INT NULL,
  ...
  INDEX `FK_Vac_Res_ReservationOID_idx` (`Vac_Res_RestrictionOID` ASC),
...
CREATE TABLE IF NOT EXISTS `spss`.`Enrollment` (
  ...
  `Enr_Can_CandidateOID` INT NULL,
  `Enr_Vac_VacancyOID` INT NULL,
  `Enr_Cur_CurriculumOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Activity` (
  `ActivityOID` INT NOT NULL AUTO_INCREMENT,
  `Description` VARCHAR(45) NULL,
  `Quantity` SMALLINT NULL,
  `Act_Cur_CurriculumOID` INT NULL,
  `Act_Kno_KnowledgeAreaOID` INT NULL,
  `Act_Aty_ActivityTypeOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Stage` (
  ...
  `ResultDate` DATETIME NULL,
  `Sta_Cal_CallOID` INT NULL,
  `Sta_Sty_StageTypeOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Graduation` (
  ...
  `Gra_Cur_CurriculumOID` INT NULL,
  `Gra_Kno_KnowledgeAreaOID` INT NULL,
  `Gra_Gty_GraduationTypeOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Role` (
  ...
  `Rol_Rty_RoleTypeOID` INT NULL,
  `Rol_Use_UserOID` INT NULL,
  PRIMARY KEY (`RoleOID`),
...
CREATE TABLE IF NOT EXISTS `spss`.`Publication` (
  ...
  `Pub_Pty_PublicationTypeOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`StageResult` (
  ...
  `Grade` DECIMAL NULL,
  `Sta_Sge_StageOID` INT NULL,
  `Sta_Enr_EnrollmentOID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `spss`.`Permission` (
  ...
  `Description` VARCHAR(45) NULL,
  `Per_Tar_TargetTypeOID` INT NULL,
  `Per_Act_ActionOID` INT NULL,
...
-- Table `spss`.`Log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spss`.`Log` ;

CREATE TABLE IF NOT EXISTS `spss`.`Log` (
  `LogOID` INT NOT NULL AUTO_INCREMENT,
  `CreationTimeStamp` DATETIME NULL,
  `targetInstance` VARCHAR(45) NULL,
  `IpAddress` VARCHAR(45) NULL,
  `Log_Use_UserOID` INT NULL,
  `Log_Tar_TargetTypeOID` INT NULL,
  `Log_Act_ActionOID` INT NULL,
  PRIMARY KEY (`LogOID`),
